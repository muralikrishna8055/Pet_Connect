...
if (isset($_POST['submit'])) { // Change to 'login' from 'submit'
    ...
    if (isset($_SESSION['doctor_id'])) {
        ...
        // Fetch form data
        $username = $_POST['username']; // Ensure you're using the correct field
        ...
        // SQL query to check doctor credentials
        $sql = "SELECT * FROM vet_doctors WHERE email = '$username' AND stat =2";
...
<body>
  ...
  <main>
    ...
    <div class="col-12">
        <p class="small mb-0">Don't have an account? <a href="doc_reg.php">Create an account</a></p>
    </div>
</form>
