...
$sql = "SELECT id, pet_image, pet_name, description,location, contact_number FROM missing_pets WHERE stat = '2'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'reject') {
        ...
        $stmt = $connection->prepare("DELETE FROM missing_pets WHERE id = ?");
    ...
    header("Location: approve_miss.php");
    exit();
}
?>
                      ...
                      while ($row = $result->fetch_assoc()) {
                          ...
                          echo '  <td>                                  
                                  ...
                                  <form action="" method="POST" style="display:inline-block;">
                                      ...
                                      <button type="submit" name="submit" value="reject" class="btn btn-sm btn-danger">Delete</button>
                                  </form>
