...
$sql = "SELECT id, name, email, profile_picture, hospital_name, contact_number FROM vet_doctors WHERE stat =2";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header("Location: delete_doctors.php"); 
...
<head>
  ...
  <title>PetConnect | Delete Doctors</title>
  <meta content="Delete doctors in PetConnect's system." name="description">
  <meta content="PetConnect, Admin, Delete Doctors, Dashboard" name="keywords">
